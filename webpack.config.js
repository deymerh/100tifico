const path = require('path') // modulo de node Nos permite acceder a donde estámos en las carpetas. Ya sea en local o en la nube.
...
module.exports = {//Aquí se encuentra toda la configuración de lo que va a suceder. Modulo para exportar.
  ...
  resolve: {
    extensions: ['.js',] //Extensiones que vamos a utilizar en el proyecto.
  },
